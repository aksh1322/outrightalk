...
interface PasswordShowVipRoomModalProps {
...
export default function PasswordShowVipRoomModal({ onClose, shouldShow, onConfirm, isCheck }: PasswordShowVipRoomModalProps) {
    ...
    return (
        <React.Fragment>
            <Modal
                ...
                keyboard={false}
                className="groupCategory show-vip-rooms theme-custom-modal"
                centered
