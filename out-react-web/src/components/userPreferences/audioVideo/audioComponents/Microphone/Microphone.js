      ...
      <Grid container justify="center">
        <Grid item>
          <IconButton onClick={handleClickOpen}>
            <MicIcon className={classes.icon} style={{color: "white"}}/>
          </IconButton>
        </Grid>
      </Grid>
        ...
        <DialogActions>
          <Grid container>
            ...
            <Grid item container justify="center" xs={12}>
              ...
              <IconButton onClick={handleDone} disabled={tempFile && !record ? false : true}>
                <DoneIcon
                  style={tempFile && !record ? { color: green[500] } : {}}
                  className={classes.icon}
                />
              </IconButton>
              <IconButton onClick={handleCancel} disabled={tempFile && !record ? false : true}>
                <CancelIcon
