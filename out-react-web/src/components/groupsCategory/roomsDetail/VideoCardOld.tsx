...
const VideoCard = memo(({ srcObject, ...props }: any) => {
  ...
  const [isTalking, setIsTalking] = React.useState<any>(false);
  ...
  //  isLocal || props.track?.kind !== "audio" ? (
  // <>
  //   <Grid
  //     container
  //     style={{
