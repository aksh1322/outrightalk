...
export function UpgradeRoomSubscriptionSuccessComponent() {
    ...
    const handleSuccess = () => {
        if (location && location.search) {
            ...
            if (parsed && parsed.session_id) {
                ...
                groupCategoryApi.callRoomSubscriptionSuccess(params, (message: string, resp: any) => {
                    if (resp) {
                    }
                }, (message: string) => {
                    console.error("Error at room subscription success call");
                })
            }
        }
    }
