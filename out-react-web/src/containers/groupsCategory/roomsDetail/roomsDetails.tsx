...
import RoomsDetailsPage from 'src/components/groupsCategory/roomsDetail/roomsDetails';
import BannerShow from 'src/components/common/banner';
import RoomBanner from 'src/components/common/RoomBanner';
import { HEADER_TYPE } from 'src/_config/site_statics';
...
export default function RoomsDetails(props: any) {

  const { roomId } = useParams<any>();

  const roomName = "room" + cryptr.decrypt(roomId);
  ...
  function toggleSetMic(data: any) {
    setMic((micList: any) => {
      ...
      let micObj: any = arr.find((c: any) => c.eventStreamId === data.eventStreamId);
  ...
  function handleSendNotificationEvent(eventType: any, publishStreamId: any, info: any) {
  ...
  function handlePublish(publishStreamId: any, token: any, subscriberId: any, subscriberCode: any) {
    // antmedia.publish(
    //   publishStreamId,
    //   token,
    //   subscriberId,
  ...
  const [userRoomJoin, setUserRoomJoin] = useState<any>("waiting")
      ...
      >
        ...
        > */}
          <div id="layout-wrapper">
            <Header type={HEADER_TYPE.ROOM_WINDOW} />
