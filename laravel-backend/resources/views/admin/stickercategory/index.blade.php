...
<div class="table-responsive">
    <table class="table table-condensed">
        <thead>
            <tr>
                <th>Category Title {!! \App\Helpers\Helper::sort($routePrefix . '.index', 'title', $orderBy) !!}</th>
                <th>Category Type {!! \App\Helpers\Helper::sort($routePrefix . '.index', 'type', $orderBy) !!}</th>   
                <th>Image</th>
