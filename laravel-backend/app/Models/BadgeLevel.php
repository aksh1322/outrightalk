...
class BadgeLevel extends Model
{
    ...
    {
        $icon = $data->icon_pic;
        $file   = \App\Models\File::upload($request, 'image', 'badge_level_icon', $data->id);
    ...
    {
        $entityType = isset(File::$fileType['badge_level_icon']['type']) ? File::$fileType['badge_level_icon']['type'] : 0;
    ...
    public function remove($id = null)
    {
        ...
        $data->delete();
        Badge::where(['level_id' => $id ])->delete();
