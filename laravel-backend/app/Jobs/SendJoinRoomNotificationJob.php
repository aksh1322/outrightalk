...
class SendJoinRoomNotificationJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (count($room_users)) {
            ...
            foreach ($room_users as $u) {
                ...
                $chat_array = [
                    'room_id' => $room_id,
                    'chat_body' => (($customized_nickname) ? $customized_nickname->nickname : $this->user->username) . ' has just joined the room.',
                    'to_user_id' => 0,
                    'type' => 'join',
